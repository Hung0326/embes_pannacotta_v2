<script setup>
  ...
  import About from '@/components/cp_home/About.vue'
...
<template>
  <Carousel/>
  <About/>
  <div class="container-fluid pt-5 pb-4 bg-white">
    <div class="container">
      <div class="row">
        <div class="col-lg-6">
          <h2 class="section-title position-relative mb-5">Sản phẩm được yêu thích</h2>
        </div>
      </div>
